...
public class JunitTest_GameTest {
	...
	/**
	 * ALREADY IMPLEMENTED; DO NOT MODIFY
	 * This private method will be used for testing purposes 
	 * 
	 */
	...
	public void test_0_0_staticFields() {
		try {
			...
			assertTrue("there should be one static field", nStatic == 1);
		} catch (Exception x) {
	...
	public void test_7_1() {
		...
		String expectedstatus = "The game is tied with no winner. Player1(3)==Pleyer2(3). Reset the game.";
		...
		assertTrue(errorMsg, actualNotickets==expectedNotickets);
		 ...
		 expectedstatus = "Player2 won the game. Player1 should pay (4) movie tickets.";
	...
	public void test_7_2() {
		...
		String expectedstatus = "Player1 score attempt number (2)";
		String errorstatusMsg = String.format(
				"\n Test Game status failed. Returned status Msg (%s) " + "but correct Msg is  (%s)\n",
				this.getGameStatus(g), expectedstatus);
		assertTrue(errorstatusMsg, this.getGameStatus(g).equals(expectedstatus));
		
		int expectedNoSucess = 3;
		String errorMsg = String.format(
				"\n Test setPlayer2AttempttoSucess failed to set sucess attempt for player2. Returned number of successful attemps for player2 (%d) "
						+ "but correct number of successful attemps for player2 is (%d)",
				getNumberofSucess(g, 1), expectedNoSucess);
		...
		expectedstatus = "The game is tied with no winner. Player1(3)==Pleyer2(3). Reset the game.";
		...
		expectedstatus = "Player1 fail to score attempt number (2)";
		errorstatusMsg = String.format(
				"\n Test Game status failed. Returned status Msg (%s) " + "but correct Msg is  (%s)\n",
				this.getGameStatus(g), expectedstatus);
		assertTrue(errorstatusMsg, this.getGameStatus(g).equals(expectedstatus));
		...
		assertTrue(errorMsg, actualNotickets==expectedNotickets);
		 ...
		 expectedstatus = "Player2 won the game. Player1 should pay (5) movie tickets.";
