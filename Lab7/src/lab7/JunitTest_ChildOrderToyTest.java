...
public class JunitTest_ChildOrderToyTest {
	...
	public void test_2_0() {
		...
		String errorMsg6 = String.format("\n Test addToy failed. Returned (%s) " + "but correct is  (%s)",
				addStr, expAddToy);
	...
	public void test_2_4() {
		...
		assertTrue(c.getChildToy().length == 2 && Math.abs (c.getChildToy()[0].getToyPrice() - 5.59)<THRESHOLD
				&& Math.abs (c.getChildToy()[1].getToyPrice() - 10.79)<THRESHOLD);
	   ...
	   // Test adding same toy name with different quantity and price 
		...
		assertTrue(c.getChildToy().length == 2 && Math.abs (c.getChildToy()[0].getToyPrice() - 5.59)<THRESHOLD
				&& Math.abs (c.getChildToy()[1].getToyPrice() - 12.85)<THRESHOLD);
		...
		assertTrue(c2.getChildToy().length == 6 && Math.abs (c2.getChildToy()[0].getToyPrice() - 98.90)<THRESHOLD
				&& Math.abs (c2.getChildToy()[2].getToyPrice() - 149.99)<THRESHOLD);
		...
		assertTrue(c2.getChildToy().length == 6 && Math.abs (c2.getChildToy()[2].getToyPrice() - 149.99)<THRESHOLD
				&& Math.abs (c2.getChildToy()[3].getToyPrice() - 21.19)<THRESHOLD);
